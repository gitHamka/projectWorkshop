...
<head>
    <meta charset="UTF-8">
    <title>Gender Preference Guide</title>
    <link rel="stylesheet" href="../assets/css/style.css">
</head>
<body>
<div class="container">
    <div class="card">
        <h2>Gender Preference Safety Guide </h2>
        <p><strong>Female Only:</strong> Only female passengers can join this ride. Recommended for female students who prefer riding with the same gender for safety and comfort.</p>
